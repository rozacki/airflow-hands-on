...
def request_highway_england(site_id=100, start_date=datetime.datetime.fromisoformat('2021-04-01')):
...
args = {'owner': 'chris'}
with DAG(dag_id=f'python_road_data', description='this is dag with single python operator', start_date=days_ago(1),
         default_args=args) as dag:
    python_operator = PythonOperator(task_id='python_operator', python_callable=request_highway_england)